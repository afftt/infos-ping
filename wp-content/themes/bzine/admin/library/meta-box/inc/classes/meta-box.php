	...
	class RW_Meta_Box
	{
		...
		public function show()
		{
			...
			foreach ( $this->fields as $field )
			{
				...
				if(isset($field['saparator'])){
					$classes = array( 'rwmb-field', 'saparator', "rwmb-{$field['type']}-wrapper" );
				}
					...
					<script type="text/javascript">
						if ( typeof rwmb == "undefined" )
						{
							var rwmb = {
								...
								summaryMessage : "' . __( 'Please correct the errors highlighted below and try again.', 'mtcframework' ) . '"
							};
						}
						else
						{
		...
		static function end_html( $html, $meta, $field )
		{
			...
			$button = '';
			if ( $field['clone'] )
				$button = '<a href="#" class="rwmb-button button-primary add-clone">' . __( '+', 'mtcframework' ) . '</a>';
		...
		{
			$button = '<a href="#" class="rwmb-button button remove-clone">' . __( '&#8211;', 'mtcframework' ) . '</a>';
