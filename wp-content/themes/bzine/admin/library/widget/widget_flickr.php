...
class mtc_widget_flickr extends WP_Widget {

	function mtc_widget_flickr() {

	// define widget title and description
	$widget_ops = array('classname' => 'flickr_widget','description' => __( 'Pulls in images from your Flickr account.','mtcframework'));
	// register the widget
	$this->WP_Widget('mtc_widget_flickr', __('MTC : Photos Flickr', 'mtcframework'), $widget_ops);
	...
	function widget( $args, $instance ) {
		...
		<div class="mtc-flickr-photo">
			<script type="text/javascript" src="http://www.flickr.com/badge_code_v2.gne?count=<?php echo $number; ?>&amp;display=latest&amp;size=s&amp;layout=h&amp;source=user&amp;user=<?php echo $id; ?>"></script>
		</div>
		<?php
	...
	<?php _e('Flickr ID ', 'mtcframework'); ?>(<a href="<?php echo 'http://www.idgettr.com';?>" target="_blank">idGettr</a>):</label>
	...
	<?php _e('Number:', 'mtcframework'); ?></label>
...
add_action('widgets_init', create_function('', 'return register_widget("mtc_widget_flickr");'));
