...
jQuery(document).ready(function($){
	...
	function GoogleFontSelect( slctr, mainID ){
		...
		console.log(_selected+' -- '+_linkclass+' -- '+_previewer);
	...
	jQuery( '.typoshow' ).on('click',function(){ 
	var mainID = jQuery(this).attr('id');
		jQuery(this).next().toggleClass('ihide');
		if(jQuery(this).next().hasClass('ihide')){
		//alert('ada');
