...
function optionsframework_add_admin() {
	...
	$of_page = add_menu_page( THEMENAME, 'MTC Options', 'edit_theme_options', 'optionsframework', 'optionsframework_options_page',ADMIN_DIR .'assets/images/logo.png',59);
 ...
 * @since 1.0.0
 */
function of_style_only($hook){

	if( 'toplevel_page_optionsframework' != $hook )
        return;
	...
	//wp_enqueue_style('jquery-ui-1.9.2.custom', ADMIN_DIR .'assets/css/jquery-ui-1.9.2.custom.css');
}	
...
function of_load_only($hook){
	...
	//wp_enqueue_script('jquery-ui-1.9.2', ADMIN_DIR .'assets/js/jquery-ui-1.9.2.custom.js', array( 'jquery' ));
}
