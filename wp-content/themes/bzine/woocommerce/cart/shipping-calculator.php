...
<form class="shipping_calculator" action="<?php echo esc_url( $woocommerce->cart->get_cart_url() ); ?>" method="post">
	...
	<a href="#" class="shipping-calculator-button btn btn-inverse pull-left"><?php _e( 'Calculate Shipping', 'woocommerce' ); ?> <span>&darr;</span></a>
	...
	<section class="shipping-calculator-form">
		...
		<p><button type="submit" name="calc_shipping" value="1" class="btn btn-success"><?php _e( 'Update Totals', 'woocommerce' ); ?></button></p>
